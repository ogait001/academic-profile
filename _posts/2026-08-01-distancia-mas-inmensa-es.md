...
subtitle: "Sobre la Trinidad, la Encarnación y el Fundamento que asumió ser lo Fundamentado"
description: "Une la teología trinitaria y la de la Encarnación con una metafísica del fundamento, mostrando cómo la acción divina sostiene el momento presente de cada criatura."
date: 2026-08-01
author: Oscar Gaitan
lang: es
categories: [Filosofia, Teologia, Trinidad, Cristologia]
excerpt: "¿Puede el Fundamento de todo ser volverse uno de los fundamentados? Una exploración teológica de la Trinidad, la Encarnación y el sostenimiento divino continuo."
doi: 10.5281/zenodo.21744700
record_url: https://zenodo.org/doi/10.5281/zenodo.21744700
pdf_url: https://zenodo.org/doi/10.5281/zenodo.21744700
...
- [I. La cuestión que se sigue del Fundamento](#i-la-cuestión-que-se-sigue-del-fundamento)
- [II. No tres nombres: las relaciones subsistentes](#ii-no-tres-nombres-las-relaciones-subsistentes)
- [III. Un solo acto, tres voces: la apropiación](#iii-un-solo-acto-tres-voces-la-apropiación)
- [IV. El caso más difícil: ¿puede el Fundamento necesitar fundamento?](#iv-el-caso-más-difícil-puede-el-fundamento-necesitar-fundamento)
- [V. Enhipóstasis: la Persona que funda su propia naturaleza](#v-enhipóstasis-la-persona-que-funda-su-propia-naturaleza)
- [VI. ¿Un esse o dos? Una cuestión que el ensayo deja abierta](#vi-un-esse-o-dos-una-cuestión-que-el-ensayo-deja-abierta)
- [VII. La gramática del intercambio: communicatio idiomatum](#vii-la-gramática-del-intercambio-communicatio-idiomatum)
- [VIII. Distancia Más Inmensa](#viii-distancia-más-inmensa)
- [IX. Lo que este ensayo no afirma](#ix-lo-que-este-ensayo-no-afirma)
...
La respuesta de la doctrina es el principio de que las obras de la Trinidad fuera de sí son indivisas: opera Trinitatis ad extra sunt indivisa. Todo acto hacia la creación --crear, sostener, redimir, santificar-- es un solo acto de la única naturaleza divina, y por tanto un acto de las Tres Personas juntas, no un acto que una sola Persona realiza en solitario mientras las otras dos observan. Lo que la Escritura y la liturgia hacen no obstante, y lo que el Catecismo sanciona bajo el nombre de apropiación, es atribuir un acto común a una Persona por conveniencia con lo que le es propio: el origen y el poder al Padre, porque es el principio sin principio; la sabiduría y el ordenamiento de las cosas al Hijo, porque es el Verbo del Padre; la bondad, el don y la conducción de las cosas a su plenitud al Espíritu, porque procede como el amor mutuo de los dos primeros exhalado hacia fuera. La creación se dice convenientemente del Padre, la redención del Hijo, la santificación del Espíritu --y cada uno de esos enunciados es verdadero, pero verdadero como apropiación, no como una asignación exclusiva de tareas. Cuando Alfa y Omega habla del Padre que mantiene abierto el Ahora, esa oración es correcta leída como apropiación. Leída como la afirmación de que solo el Padre realiza el sostenimiento, necesitaría corrección: es la Trinidad, indivisa, la que sostiene todo Ahora --el Hijo tanto como el Padre, el Espíritu tanto como cualquiera de los dos, cada uno según lo que le es propio dentro del acto único.
